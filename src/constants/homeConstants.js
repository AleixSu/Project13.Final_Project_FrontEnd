export const homeText = {
  sloganBlack: 'WHERE CONNECTIONS BECOME',
  sloganColour: 'EXPERIENCES',
  ...
  userBenefits: [
    ...
    'Cancel your attendance instantly',
    'Access your personal event history',
    'Receive automatic reminders',
    'Keep a persistent user profile',
    'Basic personalization: avatar, name, and location',
...
export const homeSrc = {
  bgVideo:
    'https://www.youtube.com/embed/_SLfDorC8OU?list=PL592B4CD53DED4217&autoplay=1&mute=1&loop=1&playlist=_SLfDorC8OU',
  frontPageLogo: '/images/darkLogo.png',
  cardPlacesUrl:
    'https://mexicorutamagica.mx/wp-content/uploads/2021/04/turismo-en-barcelona-en-3-dias.jpg',
  cardEventsUrl:
